...
class _TontonanListScreenState extends State<TontonanListScreen> {
  ...
  Widget build(BuildContext context) {
    final tontonanProv = Provider.of<TontonanProvider>(context);
    ...
    return Scaffold(
              ...
              await showDialog(
                ...
                builder: (ctx) => AlertDialog(
                  ...
                  content: TextField(
                    ...
                    decoration:
                        const InputDecoration(hintText: 'Masukkan judul film'),
                  ),
                  actions: [
                    TextButton(
      ...
      body: Column(
        children: [
          ...
          Expanded(
            child: StreamBuilder<List<Tontonan>>(
              stream: tontonanProv.semuaTontonanStream,
